  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-social">
        <a href="https://github.com/placeholder" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://x.com/placeholder" target="_blank" rel="noopener noreferrer" aria-label="Twitter/X">
        ...
        <a href="https://linkedin.com/in/placeholder" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
  ...
  <div class="section-inner">
    ...
    <div class="contact-grid">
      <div class="contact-left reveal">
        ...
        <a class="contact-email" href="mailto:hello@muizoyebowale.dev">
          <span class="ce-arrow">→</span>
          hello@muizoyebowale.dev
        </a>
