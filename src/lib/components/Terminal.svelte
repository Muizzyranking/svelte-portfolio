<script lang="ts">
  ...
  const COMMANDS: Record<string, () => Line[] | '__clear__' | '__close__'> = {
    ...
    contact: () => [
      ...
      { type: 'blank',   text: '' },
      { type: 'success', text: '  oyebowaleabdulmuiz@gmail.com' },
      { type: 'blank',   text: '' },
      { type: 'out',     text: '  GitHub    github.com/Muizzyranking' },
      { type: 'out',     text: '  Twitter   x.com/Muizzyranking' },
      { type: 'out',     text: '  LinkedIn  linkedin.com/in/muizzyrankin' },
      { type: 'blank',   text: '' },
